...
/**
 * iOS implementation of SpaceGroteskFontFamily.
 * Uses compose-resources Font() which loads synchronously on iOS.
 */
@Composable
...
/**
 * iOS implementation of NotoKufiArabicFontFamily.
 * Uses compose-resources Font() which loads synchronously on iOS.
 */
@Composable
